      ...
      <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-gray-900">{seller.metrics.overdueFollowUpCount}</p>
              <p className="text-xs text-gray-500">Muddati o'tgan F/U</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-gray-900">{seller.metrics.todayFollowUpCount}</p>
              <p className="text-xs text-gray-500">Bugungi F/U</p>
            </div>
          </div>
        </div>
      </div>
